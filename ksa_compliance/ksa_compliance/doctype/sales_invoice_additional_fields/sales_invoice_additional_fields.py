...
class SalesInvoiceAdditionalFields(Document):
    ...
    def before_insert(self):
        ...
        logger.info(f'before_insert: current integration status = {self.integration_status}')
    ...
    def submit_to_zatca(self) -> Result[str, str]:
        ...
        elif invoice_type == 'Standard' and integration_status == 'Clearance switched off':
